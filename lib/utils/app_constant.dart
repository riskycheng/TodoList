...
const String GITHUB_URL = "https://github.com/riskycheng";
const String PROJECT_URL = "https://github.com/riskycheng/TodoList";
const String ISSUE_URL = "https://github.com/riskycheng/TodoList/issues";
const String README_URL =
    "https://github.com/riskycheng/TodoList/blob/master/README.md";
const String EMAIL_URL =
    "mailto:<riskycheng@gmail.com>?subject=WhatTodo%20Query&body=Hi";
